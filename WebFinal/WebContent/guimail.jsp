           ...
           <div class="container">
	          ...
	          <h1>Gửi mail</h1>
	           ...
	           <th>
                ...
                <span class="glyphicon form-control-feedback" id="contactemail1"></span>
	         			</div>
	         			<div class ="form-group">
	         			<label for="contactsubject">Subject</label>
	         			<input type="subject" class="form-control" id="contactsubject" placeholder="Enter Subject">
	         			</div>
                 <span class="glyphicon form-control-feedback" id="contactsubject1"></span>
	         			<div class="form-group">
						<label for="contactmessage">Message</label><br>
	         			<textarea class="form-group" id="contactmessage" rows="10" cols="75"></textarea>
	         			</div>
