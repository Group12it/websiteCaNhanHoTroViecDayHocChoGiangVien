        ...
        <div class="container">
                <div class="row">
                    ...
                    <ul class="nav navs-tabs-brand">
                                ...
                                <table class="table table-striped" border="1" >
                                		...
                                		<tbody>
                                			<tr>
                                				...
                                				<td><button style="width:50% "><a href="suathreadadmin.jsp">Sửa</a></button>&nbsp;&nbsp;&nbsp;&nbsp;
                                				<button style="width:30%" ><a href="xoathreadadmin.jsp">Xóa</a></button></td>
                                			</tr>
                                			<tr>
                                				<td>2</td>
                              ...
                              <div class="col-md-1"><button type="button" class="btn btn-default">
                              <a href="taothreadadmin.jsp">Tạo Thread</a></button></div>
                    </ul>
