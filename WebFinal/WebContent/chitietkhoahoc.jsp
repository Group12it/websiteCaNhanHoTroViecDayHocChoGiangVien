                    ...
                    <div class="col-md-3">
                         <a href="#">
                            <img class="img-responsive" src="images/c.png" alt="">
                                ...
                                <h3>Khóa học lập trình hướng đối tượng</h3>
                              <p><h4>Khái quát về Lập trình hướng đối tượng C++</h4>
        ...
        <div class="modal-body">
            ...
            >
                  ...
                  <div class="form-group">
                    <label class="control-label col-md-4" for="first_name">Họ tên</label>
                    <div class="col-md-6">
            ...
            <input type="email" class="form-control" id="email" name="email" placeholder="Email Address"
                 ...
                 <div class="form-group">
                    <label class="control-label col-md-4" for="email">Số điện thoại</label>
                    <div class="col-md-6">
            <input type="number" class="form-control" id="email" name="email" placeholder="Email Address"
                        data-bv-notempty data-bv-notempty-message="An email address is mandatory"
                        />
                    </div>
                </div>
