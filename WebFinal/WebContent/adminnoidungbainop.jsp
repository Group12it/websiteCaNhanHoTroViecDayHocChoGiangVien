           ...
           <div class="container">
                <div class="row">
                    ...
                    <ul class="nav navs-tabs-brand">
                                ...
                                <a class ="list-group-item text-center " href="#" style="font-size: 20px;color: blue;background:#0CC ">Chi Tiết Bài Nộp</a> <br> <embed src="dapanhv.txt" type="" width="100%"></embed>
                                <br><br>
                                <div class="col-md-6">
                                <button type="button" class="">Nhập Điểm: <input type="number" name="Điểm" id="input Điểm" class="form-control" value="" min="{0"} max="10" step="0.5" required="required" title="" height="10" width="10"></button>
                                </div><br><br><br>
