...
<meta http-equiv="content-type" content="text/html;charset=utf-8" />
  <head>
	...
	<%@page import="connect.DBConnect" %>
      ...
      <script src="//ajax.googleapis.com/ajax/libs/jquery1.9.1/jquery.min.js" type="text/javascript"></script>
        ...
        <div class="modal fade" id="myModal" role="dialog">
            ...
            >
                      ...
                      <form hiden="hidenform" class="form-horizontal">
                        ...
                        <%}%>
                        	<label>Email:</label>
                            <input class="w3-input w3-border" type="text" name="email" ng-model="email"  placeholder="Email" >
                            <br>
                            <label>Password:</label>
                            <input class="w3-input w3-border" type="password" name="pass" ng-model="password" placeholder="Password"
                              >
                            <br>
					...
					<div class="account">
						...
						<form action="UsersServlet" method="POST">
							  ...
							  <div class="form-group">
                                  ...
                                  <input class="form-control"  id="user-result" name="email" type="text" data-bv-notempty data-bv-notempty-message="Bạn không được bỏ trống Email"
                        />        <span id="user-result" class="field-validation-valid text-danger" data-valmsg-for="Email" data-valmsg-replace="true"></span>
							...
							<input	type="submit" value="Register">
							   <button value="Register" class="w3-btn w3-green w3-ripple" >&#10004; Đăng ký</button>
            ...
            >
               <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <input type="text" class="form-control" id="dlast_name" name="last_name" placeholder="Tiêu đề"
