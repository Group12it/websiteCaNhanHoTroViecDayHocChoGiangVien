				...
				<div class="container">
					<div class="row">
						...
						<div class="col-md-12">
								...
								<form id="frmlambai" action="lam-bai-xong" method="post">
										...
										<div class="panel-body" style="padding: 0">
											<div class="panel ">
												<div class="col-md-12">
													...
													timeDisplay('aTimed',0,0,20,0,1,'btnnop');
													</script>
													</span>
													</div>
									...
									<div class=" panel panel-warning ">
										...
										<div class="panel-body">
											...
											<div class="input-group" >
												...
												<div>
													<input id="caua" type="radio" name="<%=c.getMaCau() %>"
														class="checkCauHoi" value="A"><label>A: 
															<%=c.getDanA() %>
													</label>
												</div>
												<div>
													<input id="caub" type="radio" name="<%=c.getMaCau() %>"
														class="checkCauHoi" value="B"><label>B: 
														<%=c.getDanB() %>
													</label>
												</div>
												<div>
													<input id="cauc" type="radio" name="<%=c.getMaCau() %>"
														class="checkCauHoi" value="C"><label>C:
															<%=c.getDanC() %>
													</label>
												</div>
												<div>
													<input id="caud" type="radio" name="<%=c.getMaCau() %>"
