	...
	<div class="container">
		<div class="row">
			<div class="logo col-md-6 col-sm-6 col-xs-12">
				<h1>
					<a href="trang-chu">Học lập trình</a>
				</h1>
			</div>
				...
				<div class="dropdown right">
					...
					<div class="dropdown-content" style="z-index: 1">
						<%
							if (users != null) {
						%>
						<a href="#" class="dropntn" style="z-index: 1"><%=users.getUserEmail()%></a>
						</li>
						<%
							}
		...
		<nav class="navbar navbar-default" role="navigation"
			style="color:blue;"> <!--navbar-default-->
		<div class="container" style="z-index: 0">
			<div class="navbar-header">
				<button type="button" class="navbar-toggle collapsed"
					data-toggle="collapse" data-target="#navbar" aria-expanded="false"
					aria-controls="navbar" style="z-index: 0">
				...
				<ul class="nav navbar-nav" style="color: blue;">
					...
					<c:choose>
						<c:when test="${val==1}">
							...
							<li class=""><a href="trang-chu" style="color: white;"
								title="Trang chủ">Trang chủ</a></li>
							<li class="dropdown" style="color: white;"><a href="#"
								class="dropdown-toggle" style="color: white;"
								data-toggle="dropdown" title="Các khoá học">Khoá học<span
									class="caret"></span></a>
								<ul class="dropdown-menu" role="menu">
									...
									%>
									<li><a
										href="khoa-hoc-chi-tiet?khoahoc=<%=kh.getAdMaKH()%>"><%=kh.getAdTenKH()%></a></li>
									<%
										}
									%>
								</ul></li>
							<li class="dropdown" style="color: white;"><a href="#"
								class="dropdown-toggle" style="color: white;"
								data-toggle="dropdown" title="Khoá học đã đăng ký">Khoá học
									Của tôi<span class="caret"></span>
							</a>
								<ul class="dropdown-menu" role="menu">
									<c:forEach var="rows" items="${khoahoccuatoi.rows}">
										...
										<li><a
											href="chi-tiet-khoa-hoc-cua-toi?khoahoc=${rows.MaKH}">${rows.TenKH }</a></li>
									</c:forEach>
								</ul></li>
							<li><a href="thread-thao-luan" style="color: white;"
								title="Tham gia thảo luận theo chủ đề">Thảo luận</a></li>
							<li><a href="kiem-tra" style="color: white;"
								title="Làm bài kiểm tra trong khoá học">Kiểm tra</a></li>
							<li><a href="" style="color: white; cursor: pointer"
								id="btnguimail" title="Gửi mail cho giáo viên">Liên hệ</a></li>
							<li><a href="" style="color: white;">Giới thiệu</a></li>
						</c:when>
						<c:otherwise>
							<li class=""><a href="trang-chu-quan-tri"
								style="color: white;" title="Trang chủ">Trang chủ</a></li>
							<li class="dropdown" style="color: white;"><a href="#"
								class="dropdown-toggle" style="color: white;"
								data-toggle="dropdown" title="Các khoá học">Khoá học<span
									class="caret"></span></a>
				...
				<div class="modal-body" style="padding: 40px 50px; background: #6cc">
					...
					<div class="account">
						...
						<form class="form-horizontal" id="contactform"
							name="GuiMailUserAndGuest" method="post" action="gui-email"
							...
							<div class="form-group">
								...
								<div class="col-md-8">
									<input readonly type="email" class="form-control" id="email"
										name="emailnguoigui" value="<%=users.getUserEmail()%>"
										placeholder="Địa chỉ Email" data-bv-notempty
										data-bv-notempty-message="Vui lòng nhập địa chỉ email" />
							...
							<div class="form-group">
								...
								<div class="col-md-8">
									<input type="password" class="form-control" id=""
										name="matkhauemail" placeholder="Mật khẩu mail"
										data-bv-notempty
										data-bv-notempty-message="Vui lòng nhập mật khẩu email của bạn!" />
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-8">
									<input type="text" class="form-control" id="last_name"
										name="tieude" placeholder="Tiêu đề" data-bv-notempty
										data-bv-notempty-message="Tiêu đề không được bỏ trống!" />
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-8">
									<textarea rows="6" class="form-control" id="comments"
										name="noidung" placeholder="nội dung" data-bv-notempty
										data-bv-notempty-message="Nội dung không được bỏ trống!"></textarea>
								</div>
							</div>
