								...
								<div class="panel-body">
										...
										<li class="active"><a href="gui-mail"
											class="list-group-item active" style="z-index: 0"><i
												...
												Gửi mail học viên<i class="glyphicon glyphicon-menu-right text-right"></i></a></li>
									...
									<div class="panel-body">
										...
										<div class="panel-body">
											...
											<form class="form" method="post" id="contactform"
												...
												<div class="form-group">
													<label for="contactsubject">Tiêu Đề</label> <input
														name="tieude" type="subject" class="form-control"
														id="contactsubject" placeholder="Nhập tiêu đề" required
														autofocus></input>
												</div>
												<div class="form-group">
													...
													<textarea rows="6" class="form-control" id="comments"
														name="noidung" placeholder="nội dung"></textarea>
												</div>
