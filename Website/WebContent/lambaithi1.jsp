		...
		<div class="container">
			<div class="row">
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-md-12">
								...
								<form action="KiemTraServlet" method="post">
				...
				<div class="alert alert-info">Phần trả lời trắc
					...
					int dem=0;
					int count=0;
					for(CauHoi c:cauhoiDAO.getCauHoiByMaKH("1480223244590")){dem++; %>
					...
					<section id="miSlide" class="carousel sline col-md-12"
									...
									<div class=" panel panel-warning ">
										...
										<div class="panel-body">
											<div class="input-group">
												<input name="macau" value="<%=c.getMaCau()%>">
												<div>
							...
							<%} %>
									...
									<br>
					<input name="makh" value="1480223244590">
					<input name="userid" value="<%=users.getUserID()%>">
					<input name="dem" value="<%=dem %>">			
							</div>
							</form>
						</div>
					</div>
