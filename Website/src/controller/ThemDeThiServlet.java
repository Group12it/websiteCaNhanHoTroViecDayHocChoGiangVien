...
public class ThemDeThiServlet extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			de.setMaDeThi(new java.util.Date().getTime());
			de.setTenDeThi(TenDT);
			de.setMaKH(Long.parseLong(MaKH));
			de.setFile(filePath);
