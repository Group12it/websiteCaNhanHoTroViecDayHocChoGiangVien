 ...
 */
@WebServlet("/huy-dang-ky")
public class HocVienXoaDangKy extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public HocVienXoaDangKy() {
        super();
	...
	request.getRequestDispatcher("khoa-hoc-chi-tiet?khoahoc="+makh).forward(request, response);
}
